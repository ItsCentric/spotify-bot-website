...
export default function Dashboard() {
    ...
    return (
        <div className='p-4 md:p-8'>
            <h1 className='text-4xl font-bold mb-4'>How have you been listening, <span className='text-green-light'>{session ? session.user.name : ''}</span>?</h1>
            <div className='flex flex-col md:grid md:grid-cols-2 bg-blackRaspberry-600 rounded-lg gap-8 p-4'>
                <DashboardSection heading='Your Listening Overview' subheading={`${roundToPercent(tracksMood.largest.value / tracksMood.total)}% of your recent tracks were ${adjective}.`} >
                    <Doughnut 
                        data={{
                            ...
                            datasets: [{
                                ...
                                backgroundColor: ['rgba(94, 96, 232, 0.8)', 'rgba(84, 232, 137, 0.8)', 'rgba(232, 123, 118, 0.8)', 'rgba(232, 202, 72, 0.8)'],
                            }]
                        }}
                        options={{
                            responsive: true,
