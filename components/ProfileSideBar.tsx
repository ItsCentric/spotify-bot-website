        ...
        <div className='flex flex-col gap-6 col-start-1'>
          <div className='flex flex-col py-4 px-6 gap-2 bg-white text-blackRaspberry rounded-md flex-1'>
            <div className='mx-auto p-0 relative w-auto'>
              <Image src={profileData.images[0].url} className='rounded-full border-4 border-blackRaspberry' alt='user spotify profile image' width={270} height={270} />
            </div>
            <span className='text-center text-3xl font-medium'>
                <Link href={profileData.external_urls.spotify} className='hover:text-green-dark transition-colors'>{profileData.display_name}</Link>
            </span>
